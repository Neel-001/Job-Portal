...
export const BASE_BACKEND_URL = import.meta.env.VITE_BACKEND_URL || "https://talent-nest-backend.onrender.com";
...
const API_BASE = import.meta.env.DEV ? LOCAL_BACKEND_URL : BASE_BACKEND_URL;
